...
type DesignStore = typeof initialState & {
  // --- Actions ---
  ...
  fetchDesignForEdit: (caseId: string) => Promise<IMicroTestCase | null>;
...
export const useDesignStore = create<DesignStore>((set, get) => ({
  ...
  fetchDesignForEdit: async (caseId: string) => {
    ...
    try {
      ...
      const data: IMicroTestCase = await response.json();
