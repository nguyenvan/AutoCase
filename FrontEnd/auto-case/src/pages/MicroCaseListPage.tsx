...
const MicroCaseListPage: React.FC = () => {
    ...
    const fetchMicroCases = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error('Không thể tải danh sách Micro Test Case');
            }
    ...
    const handleDelete = async (id: string, name: string) => {
        ...
        try {
            const response = await fetch(`${BACKEND_URL}/api/design/micro/${id}`, {
                method: 'DELETE',
            });
...
export default MicroCaseListPage;