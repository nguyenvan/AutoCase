...
// Định nghĩa kiểu cho item được kéo từ Toolbox
...
const DesignMacroCanvas: React.FC = () => {
    // 1. Lấy ID từ URL
    ...
    const [{ isOver }, drop] = useDrop(() => ({
        accept: "toolbox-item",
        drop: (item: ToolboxDragItem) => {
            const newComponent: ComponentMacroNode = {
                id: crypto.randomUUID(),
                microCaseId: item.microCaseId,
                microName: item.microName, // Gán microName
                type: "macro"
            };
...
export default DesignMacroCanvas;